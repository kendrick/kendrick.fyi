				...
				<section className={sharedProjectStyles['project__section']}>
					...
					<Stack>
						<p>
							...
							Compassion International, a global organization with 13
							independent fundraising offices. As the Senior Manager of UX, I
							envisioned and architected a token-based, themeable design system
							that{' '}
							<span className="k-type-emph">
								bridged the gap between design and dev
							</span>
							. We built the Compassion Design System to accelerate the design
							and development process and address fragmentation across
				...
				<section className={sharedProjectStyles['project__section']}>
					...
					<Stack>
						<p>
							...
							its local conditions nimbly, it also leaves each office
							...
							identity that left Compassion as a whole less capable of
							leveraging its internal design and development expertise because{' '}
							<span className="k-type-emph">
								teams constantly reinvented the wheel
							</span>
							. Compassion’s ongoing multi-year brand overhaul compounded this
							issue, which called for a unified global voice to solidify its
							brand identity.
						</p>
						<FYIGrid
					...
					<Stack>
						<WithSidebar sidebarOnRight sidebarWidth={imgWidthInSidebar}>
							<p>
								...
								embarked on an extensive research phase. We gathered feedback
								from development, design, and marketing teams across the globe
								through surveys and one-on-one interviews. This research
								revealed a diverse landscape: some offices had fully staffed
								design and development teams, while others consisted of just one
								or two marketers who juggled multiple roles, including web
								management. At the extreme, one office had only a full-time
								staff of two for all operations, including fundraising and
								events.
							</p>
							<FYIGrid
						...
						<Stack>
							<p>
								...
								fragmentation. Some partners used React, others were on
								WordPress, and one was on .NET. Many had plans to migrate to
								Next.js or to introduce a mobile app. The component audit
								revealed extensive fragmentation brought about by the siloed
								nature of the organization. For instance, Compassion was using
								109 types of Buttons and 23 different Card components.
							</p>
				...
				<section className={sharedProjectStyles['project__section']}>
					...
					<Stack>
						<p>
							...
							to development as the brand evolved. Design tokens emerged as a
							critical enabler of our solution, ensuring the system was
							genuinely future-proof and enabling flexibility where designers
							needed it.
						</p>
						<Switcher>
							<PullQuote>
							...
							<aside className={clsx(sharedProjectStyles.aside, styles.aside)}>
								...
								<p>
									...
									variables that define and store the values for design
									elements, such as colors, typography, spacing, and more. By
									virtue of being stored as data, design tokens bridge design
				...
				<section className={sharedProjectStyles['project__section']}>
					...
					<Stack>
						<p>
							...
							user-centered and iterative. We conducted additional user
							interviews to understand the needs of our global teams and what
							would make the components most flexible, both in Figma and in
							code. The team carefully considered the most minor details, like
							naming design tokens, to ensure clarity and consistency.
						</p>
						<Switcher threshold="80ch">
							<p>
								We partnered with teams across Compassion to establish a robust
								governance model and a streamlined design-to-development
								workflow. This workflow included tools and processes such as
								Figma for design, Tokens Studio for managing design tokens,
								GitHub for version control, Style Dictionary for transforming
								tokens into usable formats, coded components, Storybook for
								documentation, and an npm package for developers. This
								comprehensive approach facilitated a seamless workflow between
				...
				<section className={sharedProjectStyles['project__section']}>
					...
					<Stack>
						<p>
							...
							and distributed them across the organization as a shared library.
							We created a lighthearted onboarding Figma file to introduce the
							system to designers worldwide. Working closely with stakeholder
							development teams,{' '}
							<span className="k-type-emph">
								we built robust coded components
							</span>{' '}
							for React and HTML/SCSS. We then gathered and incorporated
							feedback from additional development teams to inform the creation
							of React Native components. The team implemented automated visual
							regression testing to maintain consistency and quality across
							frameworks, ensuring our design system performed reliably across
							all platforms.
						</p>
				...
				<section className={sharedProjectStyles['project__section']}>
					...
					<Stack>
						<p>
							...
							design system lacked the top-down commitment and advocacy that
						...
						<Switcher>
							...
							<Stack>
								<p>
									...
									further. This approach would enhance efficiency and
									scalability, allowing our design and development partner teams
									to focus even more on driving innovation with the Compassion
									Design System.
								</p>
							</Stack>
						</Switcher>
